# 5. Create discovery script using user's exact proven pattern

discovery_proven_code = '''"""
...
with open('discover_plc.py', 'w') as f:
    f.write(discovery_proven_code)

print("✅ 5. PLC discovery (proven pattern): discover_plc.py")